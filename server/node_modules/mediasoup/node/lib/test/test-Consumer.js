...
test('transport.consume() succeeds', async () => {
    ...
    expect(audioConsumer.rtpParameters.msid).toBe('1111-1111-1111-1111 2222-2222-2222-2222');
...
test('consumer.dump() succeeds', async () => {
    ...
    expect(dump1.rtpParameters.msid).toBe('1111-1111-1111-1111 2222-2222-2222-2222');
