...
test('dataProducer.send() succeeds', async () => {
    ...
    await new Promise((resolve, reject) => {
        dataProducer.on('listenererror', (eventName, error) => {
            reject(new Error(`dataProducer 'listenererror' [eventName:${eventName}]: ${error.toString()}`));
        });
        dataConsumer.on('listenererror', (eventName, error) => {
            reject(new Error(`dataConsumer 'listenererror' [eventName:${eventName}]: ${error.toString()}`));
        });
