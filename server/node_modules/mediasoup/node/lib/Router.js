...
class RouterImpl extends enhancedEvents_1.EnhancedEventEmitter {
    ...
    async createWebRtcTransport({ webRtcServer, listenInfos, listenIps, port, enableUdp, enableTcp, preferUdp = false, preferTcp = false, initialAvailableOutgoingBitrate = 600000, enableSctp = false, maxSendMessageSize = 262144, maxReceiveMessageSize = 262144, sctpSendBufferSize = 2000000, sctpPerStreamSendQueueLimit = 2000000, sctpMaxReceiverWindowBufferSize = 5242880, iceConsentTimeout = 30, appData, }) {
        ...
        /* direct */ undefined, initialAvailableOutgoingBitrate, enableSctp, maxSendMessageSize, maxReceiveMessageSize, sctpSendBufferSize, sctpPerStreamSendQueueLimit, sctpMaxReceiverWindowBufferSize, 
        /* isDataChannel */ true);
    ...
    async createPlainTransport({ listenInfo, rtcpListenInfo, listenIp, port, rtcpMux = true, comedia = false, enableSctp = false, maxSendMessageSize = 262144, maxReceiveMessageSize = 262144, sctpSendBufferSize = 2000000, sctpPerStreamSendQueueLimit = 2000000, sctpMaxReceiverWindowBufferSize = 5242880, enableSrtp = false, srtpCryptoSuite = 'AES_CM_128_HMAC_SHA1_80', appData, }) {
        ...
        const baseTransportOptions = new FbsTransport.OptionsT(
        /* direct */ undefined, 
        /* initialAvailableOutgoingBitrate */ undefined, enableSctp, maxSendMessageSize, maxReceiveMessageSize, sctpSendBufferSize, sctpPerStreamSendQueueLimit, sctpMaxReceiverWindowBufferSize, 
        /* isDataChannel */ false);
    ...
    async createPipeTransport({ listenInfo, listenIp, port, enableSctp = false, maxSendMessageSize = 262144, maxReceiveMessageSize = 262144, sctpSendBufferSize = 2000000, sctpPerStreamSendQueueLimit = 2000000, sctpMaxReceiverWindowBufferSize = 5242880, enableRtx = false, enableSrtp = false, appData, }) {
    ...
    async pipeToRouter({ producerId, dataProducerId, router, keepId = true, listenInfo, listenIp, enableSctp = true, maxSendMessageSize = 262144, maxReceiveMessageSize = 262144, sctpSendBufferSize = 2000000, sctpPerStreamSendQueueLimit = 2000000, sctpMaxReceiverWindowBufferSize = 5242880, enableRtx = false, enableSrtp = false, }) {
